    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Link href="/ventas/eventos" className="group">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200 hover:border-pink-400 h-full flex flex-col items-center text-center">
                        <div className="w-16 h-16 bg-pink-100 text-pink-600 rounded-full flex items-center justify-center mb-4 group-hover:bg-pink-600 group-hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z" />
                            </svg>
                        </div>
                        <h2 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-pink-600">Eventos (Catering)</h2>
                        <p className="text-gray-500 text-sm">Gestiona los productos, imágenes y cantidades para cóctel dulce y salado.</p>
                    </div>
                </Link>
            </div>
        </div>
